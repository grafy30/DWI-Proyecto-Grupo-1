        ...
        <div class="card-body">
            ...
            <form method="post" action="edit_clientes.jsp">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="direccion" name="direccion" rows="2" required><%= row.getDireccion() != null ? row.getDireccion() : "" %></textarea>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fa fa-floppy-disk fa-fw"></i> Guardar
                    </button>
                </div>
            </form>
            <% } %>
...
<section class="clientes-lista container mb-5">
    <div class="card">
        <div class="card-header">
            <h3 class="text-center mb-2">Clientes Registrados</h3>
        </div>
        <div class="card-body">
