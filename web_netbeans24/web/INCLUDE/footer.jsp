<footer class="fond" id="tempaltemo_footer">
    <div class="container">
        <div class="row">

            <div class="col-md-4 pt-5">
                <h2 class="h2 text-success border-bottom pb-3 border-light logo">Arqui-Peru</h2>
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="tel:+51 914088112">+51 914088112</a>
                    </li>
                    <li>
                        <i class="fa fa-envelope fa-fw"></i>
                        <a class="text-decoration-none" href="mailto:Arqui-Peru@info.com">Arqui-Peru@info.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li><a class="text-decoration-none" href="${pageContext.request.contextPath}/Paginas_sin_crud/Contacto.jsp">Contactanos</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-left text-light">
                        Copyright &copy; 2025 Arqui-Peru
                        | Designed by <a rel="sponsored" href="#" target="_blank">Grupo 1</a>
                    </p>
                </div>
            </div>
        </div>
