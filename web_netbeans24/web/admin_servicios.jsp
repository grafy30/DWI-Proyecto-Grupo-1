...
<%
    ...
    List<ServiciosBE> lista = serviciosBL.listarServicios();  // Obtener todos los servicios desde la lógica de negocio
%>
<!DOCTYPE html>
<html>
<head>
    <title>Administración de Servicios</title>
    <%@ include file="INCLUDE/header_links.jsp" %> <!-- Enlazar con el archivo de cabecera -->
...
<div class="container mt-4">
    <div class="form-card full-width">
        <div class="mb-4 d-flex justify-content-end gap-2">
            <a href="${pageContext.request.contextPath}/registrar_servicio.jsp">
